...
import { BookDisplay, createPreview } from "./Modules/bookUtility.js";
...
const handlerListItems = (event) => {
    ...
    const previewCreate = createPreview()
    previewCreate.checkPreviewID(event)
    previewCreate.generatePreview()
    previewCreate.active = 'Yellow'
